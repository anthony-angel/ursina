...
if __name__ == '__main__':
    ...
    trail_renderer1 = TrailRenderer(parent=player, thickness=100, color=color.yellow, length=6)

    pivot = Entity(parent=player)
    trail_renderer2 = TrailRenderer(parent=pivot, x=.1, thickness=20, color=color.orange)
    trail_renderer3 = TrailRenderer(parent=pivot, y=1, thickness=20, color=color.orange)
    trail_renderer4 = TrailRenderer(parent=pivot, thickness=2, color=color.orange, alpha=.5, position=(.4, .8))
    trail_renderer5 = TrailRenderer(parent=pivot, thickness=2, color=color.orange, alpha=.5, position=(-.5, .7))
